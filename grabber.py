...
my_cook = {
	"ZHE" : "63b050ece78d75313443ff9049de0d4b",
	"PHPSESSID" : "9cps0u5gm4h1d04m0cjktsnmg2"
	}
...
\__,_/ /___/_/ /___/      
                                  ...
                                  Script Name : zone grabber ^_^
                	Greetz To : \033[93mtunisian \033[92mHackers  \033[91m|D\033[92mz| \033[91mAlgeria \033[92mHackers
                                     """)
	slowprint("\n\t\t\t\t\tPowered By : dhaoui_Aziz" + "\n\t\t\t\t\t\t Telegram : @pycharm1       whatsapp:95600500")
	print("")
	print("""
		...
		\033[91m[9] \033[95mEmail Valid Spotify
			...
			#######################################################
			# 	  Love 4 Palestine |\033[91m| Love 4 tunisia #
			#######################################################
			""")		
	try:
